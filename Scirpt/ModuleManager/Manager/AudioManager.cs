...
namespace GDG.ModuleManager
{
    public class AudioManager : LazySingleton<AudioManager>
    {
        public AudioManager()
        {
            MonoWorld.Instance.AddOrRemoveListener(Update,"Update");
        ...
        /// 音乐暂停
        /// </summary>
        public static void PauseMusic_Global() => music?.Pause();
        /// <summary>
        /// 音乐停止
        /// </summary>
        public static void StopMusic_Global() => music?.Stop();
        /// <summary>
        /// 设置音量大小
        /// </summary>
        public static void SetMusicVolume_Global(float value)
        {
            if (music != null)
                music.volume = value;
        }
        public static void StopAllAudio_Global()
        {
            StopMusic_Global();
            StopSound_Global();
        }
        ...
        /// 停止播放所以音效
        /// </summary>
        public static void StopSound_Global()
        {
            foreach (var sound in soundlist)
            {
                Object.Destroy(sound);
        ...
        public static void SetAllAudioVolume_Global(float value)
        {
            SetSoundVolume_Global(value);
            SetMusicVolume_Global(value);
        }
        /// <summary>
        /// 设置音效的大小
        /// </summary>
        /// <param name="value"></param>
        public static void SetSoundVolume_Global(float value)
        {
            foreach (var sound in soundlist)
            {
                if (sound != null)
